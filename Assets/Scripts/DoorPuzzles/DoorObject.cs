...
public class DoorObject : MonoBehaviour
{
    ...
    private IEnumerator OpeningDoor(Transform pivote, Vector3? pos = null) //"Animaci�n" de abrir puerta
    {
        isOpening = true;
    ...
    public void OpenDoor()
    {
        ...
        StartCoroutine(OpeningDoor(pivote)); //Empieza el m�todo de abrir puerta 
    ...
    public void OpenDoorWithoutPivot(Vector3? pos = null)
    {
        ...
        StartCoroutine(OpeningDoor(pivote, pos)); //Empieza el m�todo de abrir puerta 
    }
}
